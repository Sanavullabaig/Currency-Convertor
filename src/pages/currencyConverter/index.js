...
function currencyConverter(props) {
  ...
  const handleConvert = () => {
    ...
    fetch(
      `${URL}/${selectedCurrencyFrom.value}/${selectedCurrencyTo.value}/${selectAmount}`,
      { signal }
    )
      .then((res) => res.json())
      .then((data) => {
        ...
        <div className="row">
          {isLoading ? (
            <div
              ...
              id="loader"
            >
              <FadeLoader className="mt-auto" size="20" color="#1746A2" />{" "}
            </div>
          ) : (
            ""
          )}
          <div
            className={`col-md-10 col-sm-10 mx-auto currency-container ${
              isLoading ? "blur-2" : ""
            }`}
          >
            <div className="row mb-4">
              <div className="col-md-3">
                <div className="div1">
                  <label className="text-uppercase lbl-title font-weight-bold mb-10">
                    Amount
                  </label>
                  <div className="flex">
            ...
            <div className="row mb-2">
                  ...
                  <div className="col-md-12">
                    <div className={`result-container ${reslultContaierCls}`}>
                      {isLoading ? (
                        ...
                        <>
                          <p className="mb-0">
                            <span className="result-currency-from">
                              {exchangedSelectAmount}{" "}
                              {selectedCurrencyFrom.name} =
                            </span>
                            <span className="result-currency-to">
                              {" "}
                              {exchangeRateAmount} {selectedCurrencyTo.name}
                            </span>
                          </p>
                          <p>
                            <span className="exchange-rate">
                              1 {selectedCurrencyFrom.value} = {exchangeRate}{" "}
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-11">
                            <div className="disclaimer-text-container">
                              <span>
                                We use third party resources & the mid-market
                                rate for our Converter. This is for
                                informational purposes only. We don't claim this
                                is exact exchange rate.
                              </span>
                            </div>
                          </div>
                        </div>
              ...
              <div className="col-md-2 text-right">
                <button
                  ...
                  type="button"
                  className="btn-convert btn btn-outline-primary text-uppercase text-right"
                >
                  convert
                </button>
              </div>
